...
const routes = [
    {
        ...
        children: [
            {
                path: 'tab1',
                loadChildren: () => Promise.all(/*! import() | tab1-tab1-module */[__webpack_require__.e("common"), __webpack_require__.e("tab1-tab1-module")]).then(__webpack_require__.bind(null, /*! ../tab1/tab1.module */ "./src/app/pages/tab1/tab1.module.ts")).then(m => m.Tab1PageModule)
            },
            {
                path: 'tab2',
            ...
            {
                path: 'tab1/agregar/:listaId',
                loadChildren: () => Promise.all(/*! import() | agregar-agregar-module */[__webpack_require__.e("common"), __webpack_require__.e("agregar-agregar-module")]).then(__webpack_require__.bind(null, /*! ../agregar/agregar.module */ "./src/app/pages/agregar/agregar.module.ts")).then(m => m.AgregarPageModule)
            },
            {
                path: 'tab2/agregar/:listaId',
                loadChildren: () => Promise.all(/*! import() | agregar-agregar-module */[__webpack_require__.e("common"), __webpack_require__.e("agregar-agregar-module")]).then(__webpack_require__.bind(null, /*! ../agregar/agregar.module */ "./src/app/pages/agregar/agregar.module.ts")).then(m => m.AgregarPageModule)
            },
            {
                path: '',
